// CopyArrayOtherWay.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
void ReadArrayNumbers(int& number,int arr[100], int& arrlength) {
    arrlength++;
...
void ReadArrayCopy(int arr[100], int arrcopied[100], int arrlength, int arrcopiedlength) {
    ...
    for (int i = 0; i < arrlength; i++) {
         ...
         ReadArrayNumbers(arr[i], arrcopied, arrcopiedlength);

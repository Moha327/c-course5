// CountPositiveNumbers.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
#include <iostream>
using namespace std;
...
int NumberOfPositiveNmbersArrayCopy(int arrcopied[100], int arrcopiedlength) {
    int counter = 0;
...
int main() {
    ...
    cout << "Number of positive numbers is : ";
    cout << NumberOfPositiveNmbersArrayCopy(arrcopied, arrcopiedlength);
    return 0;
}

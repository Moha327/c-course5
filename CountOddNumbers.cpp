// CountOddNumbers.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
void PrintNumberOfOddNmbersArrayCopy(int arrcopied[100], int arrcopiedlength) {
    int counter = 0;
...
int main() {
    ...
    cout << "Number of odd numbers is : ";
    PrintNumberOfOddNmbersArrayCopy(arrcopied, arrcopiedlength);
    return 0;
}
